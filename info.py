...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5897956388 5019668523 6302921275').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002000308663 -1001975749985').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002000308663') # give your force subscribe channel id here else leave it blank
...
LANGUAGES = ["malayalam", "mal", "tamil", "tam" ,"english", "eng", "hindi", "hin", "telugu", "tel", "kannada", "kan", "punjabi", "pun", "bengali", "ben"]
